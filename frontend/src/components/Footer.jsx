...
export default function Footer() {
  return (
    <footer class=" bg-[#F6F7EB] pl-5 pr-5">
      <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="footerContainer">
            <div class="flex justify-center mb-3 text-teal-600 sm:justify-start">
            <img className="logofooter" src="https://i.imgur.com/P7DVc52.png" alt="logo" />
            </div>

            <p
              class="max-w-md mx-auto leading-relaxed text-center text-gray-500 sm:max-w-xs sm:mx-0 sm:text-left"
            >
          ...
          >
            <div class="text-center sm:text-left ">
              <p class="text-lg fontPoppins font-medium text-gray-900">Nosotros</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg fontPoppins font-medium text-gray-900">Nuestros Productos</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg fontPoppins font-medium text-gray-900">Enlaces Utiles</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg fontPoppins font-medium text-gray-900">Contactanos</p>
              ...
              <ul class="mt-8 space-y-4 text-sm">
                <li>
                  ...
                  >
                    ...
                    <span class="text-gray-700">contacto@boxbonny.com</span>
                  </a>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="text-gray-700">+54114324875</span>
                  </a>
                </li>
                ...
                >
                  ...
                  <address class="-mt-0.5 not-italic text-gray-700">
                    Salguero 3172 - Buenos Aires - Argentina
                  </address>
                </li>
              </ul>
            </div>
