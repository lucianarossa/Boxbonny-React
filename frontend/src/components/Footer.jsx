        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          >
            <div class="text-center sm:text-left ">
              <p class="text-lg fontPoppins font-medium text-gray-900">About Us</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg fontPoppins font-medium text-gray-900">Our Services</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg fontPoppins font-medium text-gray-900">Helpful Links</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg fontPoppins font-medium text-gray-900">Contact Us</p>
