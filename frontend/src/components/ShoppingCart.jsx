        ...
        <div class="flex shadow-md my-10">
          <div class="w-3/4 bg-white px-10 py-10">
            ...
            <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div class="flex w-2/5">
                ...
                <div class="flex flex-col justify-between ml-4 flex-grow">
                  ...
                  <a href="#" class="font-semibold hover:text-red-500 text-gray-500 text-xs">🗑️Eliminar</a>
                </div>
              </div>
            ...
            <a href="#" class="flex font-semibold text-orange-600 text-sm mt-10">
              ...
              <svg class="fill-current mr-2 text-orange-600 w-4" viewBox="0 0 448 512"><path d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z" /></svg>
              Continuar Comprando
            </a>
          </div>
          ...
          <div id="summary" class="w-1/4 px-8 py-10">
            ...
            <button class="bg-slate-900 hover:bg-slate-700 px-5 py-2 text-sm text-white uppercase">Applicar</button>
            <div class="border-t mt-8">
              <div class="flex font-semibold justify-between py-6 text-sm uppercase">
                <span>Total cost</span>
                <span>$600</span>
              </div>
              <button class="bg-orange-500 font-semibold hover:bg-orange-600 py-3 text-sm text-white uppercase w-full">PROCEDER A LA COMPRA</button>
            </div>
          </div>
